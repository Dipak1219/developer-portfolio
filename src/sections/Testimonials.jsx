...
const testimonials = [
  {
    ...
    review:
      "Dipak is a visionary developer. His attention to detail and creativity blew us away. Our project was a massive success because of him.",
    image: m1,
  },
  {
    ...
    review:
      "Working with Dipak was an absolute pleasure. He brings design and code together like magic. Highly recommend him!",
    image: w1,
  },
  {
    name: "Amy Jacobsan",
    ...
    review:
      "From concept to execution, Dipak handled everything flawlessly. His work ethic and innovation are unmatched.",
    image: m2,
  },
  {
    name: "Carry Smith",
    ...
    review:
      "Dipak transformed our outdated platform into something modern and powerful. His skills are world-class.",
    image: w2,
  },
];
...
const Testimonials = () => {
  return (
    <section id='testimonials' className='relative min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 py-20'>
      ...
      <div id='card' className='grid grid-cols-1 sm:grid-cols-2 gap-10 max-w-6xl w-full'>
        {
